...
/**
 * Implementation of the Printer interface, producing bills in HTML.
 */
public class HtmlPrinter implements Printer {
	...
	public void printHeading(String name, String phoneNumber,
	  	String pricePlan) {
	  	beginHtml();
	  	printStream.println(h2(name + "/" + phoneNumber + " - " + "Price Plan: "
	  		+ pricePlan));
	  	beginTable();
	}
	...
	private void beginTable() {
		...
		printStream.println(tr(th("Time") + th("Number") + th("Duration") +
  			th("Cost")));
	}
